...
Mean_Diff <- Mean_Steps_per_day_Imputed - Mean_Steps_per_day
Median_Diff <- Median_Steps_per_day_Imputed - Median_Steps_per_day
Total_Diff <- sum(Steps_per_day_Imp$steps) - sum(Steps_per_day$steps)
```
